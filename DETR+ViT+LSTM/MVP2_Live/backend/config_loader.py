...
from paths import MVP2_BACKEND_DIR
...
def load_config(config_path: str | Path | None = None) -> AppConfig:
    config_path = Path(config_path or MVP2_BACKEND_DIR / "config.yaml")
    ...
    return AppConfig(
        ...
        stability_seconds=float(raw.get("stability_seconds", 5)),
        ...
        alert_cooldown_seconds=float(raw.get("alert_cooldown_seconds", 30)),
